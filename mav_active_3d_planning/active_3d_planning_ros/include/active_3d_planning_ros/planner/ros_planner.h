...
class RosPlanner : public OnlinePlanner {
 public:
  ...
  void replan_singal_Callback(const std_msgs::Int32& msg);
  ...
  void publishVisualization_local_traj(const VisualizationMarkers& markers) override;
 ...
 protected:
  ...
  ::ros::Subscriber replan_singal_sub_;

  ::ros::Publisher target_pub_;
  ::ros::Publisher traj_pub_;

  ::ros::Publisher trajectory_vis_pub_;
  ::ros::Publisher local_trajectory_vis_pub_;
  ...
  void requestMovement(const EigenTrajectoryPoint& trajectory_point) override;
