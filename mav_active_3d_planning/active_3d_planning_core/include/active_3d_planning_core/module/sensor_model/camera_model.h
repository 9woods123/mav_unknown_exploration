#ifndef ACTIVE_3D_PLANNING_CORE_MODULE_SENSOR_MODEL_CAMERA_MODEL_H_
#define ACTIVE_3D_PLANNING_CORE_MODULE_SENSOR_MODEL_CAMERA_MODEL_H_
...
class CameraModel : public SensorModel {
 public:
  explicit CameraModel(PlannerI& planner);  // NOLINT
...
#endif  // ACTIVE_3D_PLANNING_CORE_MODULE_SENSOR_MODEL_CAMERA_MODEL_H_
