...
int main(int argc, char** argv) {
  ...
  nh_private.param<double>("wp_x", trajectory_point.position_W.x(), 0.0);
  nh_private.param<double>("wp_y", trajectory_point.position_W.y(), 0.0);
...
for (double i = 0; i <=0.5 ; i = i + 0.05) {
    ...
    trajectory_point.position_W.z()=i*2.45;
